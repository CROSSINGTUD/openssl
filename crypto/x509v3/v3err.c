...
static const ERR_STRING_DATA X509V3_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_CREATE_DUMMY_EXTENSION, 0),
     "create_dummy_extension"},
    ...
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_HYBRID_SIGNATURE_SIGN, 0),
     "HYBRID_SIGNATURE_sign"},
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_HYBRID_SIGNATURE_VERIFY, 0),
     "HYBRID_SIGNATURE_verify"},
    ...
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_V2I_GENERAL_NAME_EX, 0),
     "v2i_GENERAL_NAME_ex"},
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_V2I_HYBRIDKEY, 0), "v2i_HybridKey"},
    {ERR_PACK(ERR_LIB_X509V3, X509V3_F_V2I_HYBRIDSIG, 0), "v2i_HybridSig"},
...
static const ERR_STRING_DATA X509V3_str_reasons[] = {
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_BAD_HYBRID_SIGNATURE_ALGORITHM),
    "bad hybrid signature algorithm"},
    ...
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_FAILURE_OPENING_KEY_FILE),
    "failure opening key file"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_FAILURE_READING_KEY_FILE),
    "failure reading key file"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_HYBRID_SIGNATURE_PARSING_FAILURE),
    "hybrid signature parsing failure"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_HYBRID_SIGNATURE_SIGNING_FAILURE),
    "hybrid signature signing failure"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_HYBRID_SIGNATURE_VERIFICATION_FAILURE),
    "hybrid signature verification failure"},
    ...
    "no config database"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_NO_HYBRID_SIGNATURE_EXTENSION),
    "no hybrid signature extension"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_NO_HYBRID_SIGNATURE_TO_VERIFY),
    "no hybrid signature to verify"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_NO_ISSUER_CERTIFICATE),
    "no issuer certificate"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_NO_ISSUER_DETAILS),
    "no issuer details"},
    {ERR_PACK(ERR_LIB_X509V3, 0, X509V3_R_NO_KEY_FOR_HYBRID_SIGNATURE),
    "no key for hybrid signature"},
